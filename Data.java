...
// V={0,1, 2, 3, 4,5,6,7}= 
    ...
    public static double[][] costs() {// matrix size 8x8
        ...
        double[][] costs = {
            //0    1    2     3    4    5   6     7
            {100, 5.5, 4.2, 2.6, 2.4, 1.3, 2.5, 4.3,},// Node 0
            {4.7, 100, 3.7, 2.1, 5.1, 6, 7.2, 9,},// Node 1
            {4.2, 4.5, 100, 1.6, 3.2, 5.5, 6.7, 8.5,}, // Node 2
            {2.6, 2.9, 1.6, 100, 3, 3.9, 5.1, 6.9,},// Node 3
            {3.8, 4.1, 2.8, 1.2, 100, 5.1, 6.3, 8.1,},// Node 4
            {3.9, 7.4, 6.1, 4.5, 3.3, 100, 1.2, 3,},// Node 5 
            {3.5, 7, 5.7, 4.1, 2.9, 1.2, 100, 2.3,},// Node 6
            {5.8, 9.3, 8, 6.4, 5.2, 3, 2.3, 100,},// Node 7
        };
